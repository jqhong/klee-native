...
class KModule {
 ...
 private:
  ...
  void addInternalFunction(llvm::Module *mod, const char* functionName);
 ...
 public:
  ...
  //
  void optimiseAndPrepare(llvm::Module *mod,
  ...
  void manifest(llvm::Module *mod, InterpreterHandler *ih,
  ...
  void instrument(llvm::Module *mod, const Interpreter::ModuleOptions &opts);
